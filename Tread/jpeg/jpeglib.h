...
extern void LoadJPGBuff(unsigned char *fbuffer, unsigned char **pic, int *width, int *height, int *depth );
extern void ReadJPGInfo(unsigned char *fbuffer, int *width, int *height, int *depth );
